    ...
    return (
      <div className="w-full min-h-screen bg-[#F7EBE0] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[#6A2A43] font-semibold">Loading...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full min-h-screen bg-[#F7EBE0]">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-[#6A2A43] mb-2">Access Denied</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-1">
            <div className="sticky top-4">
              <div className="bg-white rounded-lg shadow-md p-4">
                <h2 className="text-lg font-bold text-[#6A2A43] mb-4">Admin</h2>
                <AdminNav />
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3">
            {/* Header Section */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-[#6A2A43] mb-2">{title}</h1>
