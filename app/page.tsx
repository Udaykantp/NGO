...
const CornerSticker = ({ className = '' }: { className?: string }) => (
  <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={`absolute z-10 pointer-events-none ${className}`}>
    <path d="M50 0L100 50L50 100L0 50L50 0Z" fill="#241601"/>
    <path d="M50 15L85 50L50 85L15 50L50 15Z" fill="#F46403"/>
    <path d="M50 30L70 50L50 70L30 50L50 30Z" fill="#4D7A4C"/>
    <path d="M50 42L58 50L50 58L42 50L50 42Z" fill="#241601"/>
  </svg>
);

const SunDoodle = ({ className = '' }: { className?: string }) => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#241601" strokeWidth="2" className={`opacity-60 stroke-[2px] pointer-events-none ${className}`} strokeLinecap="round" strokeLinejoin="round">
...
const CloudDoodle = ({ className = '' }: { className?: string }) => (
  <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#241601" strokeWidth="2" className={`opacity-60 stroke-[2px] pointer-events-none ${className}`} strokeLinecap="round" strokeLinejoin="round">
    <path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" />
  </svg>
);

const LeafDoodle = ({ className = '' }: { className?: string }) => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#241601" strokeWidth="2" className={`opacity-60 stroke-[2px] pointer-events-none ${className}`} strokeLinecap="round" strokeLinejoin="round">
...
export default function Home() {
  return (
    <div className="w-full min-h-screen bg-[#FCFCF9] text-[#6E675A] font-sans">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10 w-full">
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            ...
            <a href="https://wa.me/9891075655?text=Hello! I would like to make a donation." target="_blank" rel="noopener noreferrer" className="bg-[#F46403] hover:bg-[#D95200] text-white font-bold px-8 py-[14px] rounded-full transition duration-300 shadow-md w-full md:w-auto">
              Donate Now
            </a>
          </div>
        </div>
      ...
      {/* Products Section */}
      <section className="w-full bg-[#FCFCF9] py-20 md:py-32 relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <p className="text-[#211600] mb-6 font-semibold">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex bg-[#F46403] hover:bg-[#D95200] text-white font-bold px-8 py-[14px] rounded-full transition duration-300 shadow-md items-center justify-center gap-2"
            >
      ...
      <section className="w-full bg-[#FCFCF9] py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-10 rounded-[24px] shadow-[0_18px_40px_rgba(20,12,0,0.12)] border border-[rgba(36,22,1,0.06)] hover:-translate-y-[5px] transition duration-300 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 bg-[#241601] text-white rounded-full flex items-center justify-center shadow-sm">
                ...
                <h3 className="text-2xl font-extrabold tracking-[-0.05em] text-[#211600]">Our Vision</h3>
              </div>
              <p className="text-[#6E675A] leading-[1.8]">
            ...
            <div className="bg-white p-10 rounded-[24px] shadow-[0_18px_40px_rgba(20,12,0,0.12)] border border-[rgba(36,22,1,0.06)] hover:-translate-y-[5px] transition duration-300 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-extrabold tracking-[-0.05em] text-[#211600]">Our Mission</h3>
              </div>
              <p className="text-[#6E675A] leading-[1.8]">
          ...
          <div className="mt-16 grid md:grid-cols-5 gap-6">
            {[
              { icon: <svg className="w-10 h-10 mx-auto" viewBox="0 0 24 24" fill="#F9D05F" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>, title: 'Skill Development' },
              { icon: <svg className="w-10 h-10 mx-auto" viewBox="0 0 24 24" fill="#F46403" xmlns="http://www.w3.org/2000/svg"><path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/></svg>, title: 'Economic Independence' },
              { icon: <svg className="w-10 h-10 mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="5" fill="#F9D05F"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" stroke="#F9D05F" strokeWidth="2" strokeLinecap="round"/></svg>, title: 'Self-Reliance' },
              { icon: <svg className="w-10 h-10 mx-auto" viewBox="0 0 24 24" fill="#4E9B71" xmlns="http://www.w3.org/2000/svg"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>, title: 'Community Support' },
              { icon: <svg className="w-10 h-10 mx-auto" viewBox="0 0 24 24" fill="#F46403" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>, title: 'Women Welfare' },
            ].map((value, index) => (
                  <div key={index} className="bg-white p-6 rounded-[24px] text-center shadow-[0_8px_24px_rgba(20,12,0,0.06)] hover:shadow-[0_18px_40px_rgba(20,12,0,0.12)] border border-[rgba(36,22,1,0.06)] hover:-translate-y-[5px] transition duration-300">
                <div className="mb-4">{value.icon}</div>
                    <h4 className="font-extrabold tracking-[-0.02em] text-[#211600]">{value.title}</h4>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                icon: <svg className="w-8 h-8 text-[#F9D05F]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>,
      ...
      {/* CTA Section */}
      <section className="w-full bg-[#CCD3B1] py-24 md:py-32 relative overflow-hidden">
        <CornerSticker className="-top-8 -left-8 md:-top-4 md:-left-4" />
        <CornerSticker className="-bottom-8 -right-8 md:-bottom-4 md:-right-4 transform rotate-180" />
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-[-0.05em] text-[#211600] mb-6 leading-snug md:leading-tight">
            जब महिलाएँ आत्मनिर्भर बनती हैं, तभी समाज और देश आगे बढ़ता है!
          </h2>
          <p className="text-[#211600]/80 text-xl md:text-2xl mb-8 max-w-3xl mx-auto font-medium">
            When women become self-reliant, society and the nation progress forward!
          </p>
          <p className="text-[#241601]/70 mb-12 max-w-2xl mx-auto leading-[1.8]">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <button className="bg-[#F46403] hover:bg-[#D95200] text-white font-bold px-10 py-[16px] rounded-full transition duration-300 shadow-md">
              Donate Now
            </button>
            <button className="bg-white border border-[rgba(36,22,1,0.06)] hover:bg-[#F8F8F0] text-[#211600] font-bold px-10 py-[16px] rounded-full transition duration-300 shadow-[0_8px_16px_rgba(20,12,0,0.05)]">
              Become a Volunteer
            </button>
            <button className="bg-transparent border border-[rgba(36,22,1,0.15)] hover:bg-[#241601]/5 text-[#211600] font-bold px-10 py-[16px] rounded-full transition duration-300">
              Learn More
            </button>
          </div>
        </div>
